// Mock data for APOM DApp - Gaming & DeFi Platform
...
const initializeMockData = () => {
  ...
  mockData.games = [
    {
      ...
      genre: 'RPG',
      description: 'Epic blockchain RPG where you battle, collect, and trade NFT warriors',
    ...
    },
    {
      ...
      title: 'Yield Quest',
      genre: 'Strategy',
      description: 'Strategic DeFi game where you build and manage yield farming operations',
      ...
      features: ['Yield Farming', 'Portfolio Management', 'Risk Assessment', 'Competitions']
    },
    {
      id: 'game_003',
      title: 'NFT Racing',
      genre: 'Racing',
      description: 'High-speed racing game with customizable NFT vehicles and tracks',
      ...
      features: ['Custom Cars', 'Track Editor', 'Multiplayer Races', 'Car Trading']
    }
  ];
  ...
  mockData.governanceProposals = [
    ...
    },
    {
      ...
      description: 'Proposal to add APOM-BTC liquidity pool',
      category: 'DeFi',
      status: 'pending',
      creator: 'user_002',
...
const getDefiPoolById = (id) => mockData.defiPools.find(pool => pool.id === id);
const getNftCollectionById = (id) => mockData.nftCollections.find(collection => collection.id === id);
const getNftById = (id) => mockData.nfts.find(nft => nft.id === id);
const getLaunchpadProjectById = (id) => mockData.launchpadProjects.find(project => project.id === id);
const getGovernanceProposalById = (id) => mockData.governanceProposals.find(proposal => proposal.id === id);
